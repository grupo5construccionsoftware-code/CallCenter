...
<div class="container">
  <section class="login-shell">
    <main class="login-box">
      ...
      <p>El acceso interno habilita los módulos operativos, las métricas y el resto de pantallas privadas.</p>
      <form action="/dashboard">
        <div class="form-grid">
          <div>
            <label for="usuario-login">Usuario</label>
            <input type="text" id="usuario-login" name="usuario" placeholder="Tu usuario">
          </div>
          <div>
            <label for="contraseña-login">Contraseña</label>
            <input type="password" id="contraseña-login" name="Contraseña" placeholder="Tu contraseña">
          </div>
        </div>
